...
const Header = ({showSidebar, setShowSidebar}) => {
    ...
    return (
        ...
        <div className='hidden md:block'>
          <input className='px-3 py-2 outline-none border bg-transparent border-slate-700 rounded-md text-[#000000] focus:border-indigo-300 overflow-hidden' type="text" name='search' placeholder='Search' />
        </div>
